        ...
        async def send():
            ...
            while True:
                ...
                await session.set_weighted_prompts(
                    prompts=[{"text": "hardstyle lead", "weight": 2.0},types.WeightedPrompt(text="Meditation", weight=0.5),types.WeightedPrompt(text="Live Performance", weight=1.0),])
        print("Starting with some piano")
        await session.set_weighted_prompts(prompts=[{"text": "synthwave", "weight": 2.0},types.WeightedPrompt(text="winter", weight=0.5),types.WeightedPrompt(text="hardstyle lead", weight=1.0),])
